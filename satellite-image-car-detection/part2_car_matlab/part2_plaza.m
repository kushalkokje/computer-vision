...
% Laplacian detects cleaner edges. But with less edge points detected, it
% is better to user Champer distance.
...
colorbar
axis equal tight
title('Template for Plaza');
saveas(gcf,'./Plaza_template1.jpg');
close(gcf);
% Template 2
x_a = 360; x_b = 386; y_a = 111; y_b = 145; % Plaza template
template_1 = X_canny_255(x_a:x_b,y_a:y_b);
size(template_1);
figure
image(template_1)
...
axis equal tight
title('Template for Plaza');
saveas(gcf,'./Plaza_template2.jpg');
close(gcf);
% Template 3
x_a = 425; x_b = 441; y_a = 1272; y_b = 1312; % Plaza template
template_1 = X_canny_255(x_a:x_b,y_a:y_b);
size(template_1);
figure
image(template_1)
...
axis equal tight
title('Template for Plaza');
saveas(gcf,'./Plaza_template3.jpg');
close(gcf);
...
saveas(gcf,'./Plaza_detected_3.jpg');
close(gcf);
%%
...
fileID = fopen('Plaza_location.txt','w');
